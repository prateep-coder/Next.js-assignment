  ...
  switch (method) {
    case 'GET':
      try {
        ...
        if (slug) {
          ...
          return product ? res.json({ success: true, data: product }) : res.status(404).json({ error: 'Not found' })
        }
    ...
    case 'PUT':
      ...
      try {
        ...
        products[index] = { ...products[index], ...req.body, lastUpdated: new Date().toISOString() }
