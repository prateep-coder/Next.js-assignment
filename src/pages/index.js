    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-blue-50">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="flex gap-6">
              <Link href="/" className="font-semibold border-b-2 border-white pb-1">Home</Link>
      ...
      <section className="gradient-bg text-white py-16 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl mb-8">Find the latest gadgets and electronics</p>
          <input
            type="text"
      ...
      <section className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {products.map(product => (
            <div key={product.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 overflow-hidden">
